...
-- Generation Time: 2022-02-03 04:53:10.1990
-- -------------------------------------------------------------
...
CREATE TABLE `movie_posters` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `movie_posters_movie_id_unique` (`movie_id`),
  CONSTRAINT `movie_posters_movie_id_foreign` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE
